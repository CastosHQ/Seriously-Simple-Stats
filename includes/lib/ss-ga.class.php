 ...
 * from https://github.com/dancameron/server-side-google-analytics
 *
 */

class ssga {
	
    const GA_URL = 'https://www.google-analytics.com/__utm.gif'; //@nczz update v5.6.4dc
	...
	public function __construct( $UA = null, $domain = null ) {
        ...
        $this->data['utmip'] = $_SERVER['REMOTE_ADDR'];
	}
	...
	public function set_ip( $var = null ) {
        return $this->data['utmip'] = $var;
    }
	...
	public function set_referral( $var = null ) {
